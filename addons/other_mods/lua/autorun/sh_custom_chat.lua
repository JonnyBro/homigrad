...
CreateConVar("custom_chat_safe_mode", "0", bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY), "Enable safe mode to all players. Only show images after clicking them.", 0, 1)
CreateConVar("custom_chat_allow_colors", "1", bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY), "Allows the usage of color formatting options. Recommended to be disabled on servers.", 0, 1)
CreateConVar("custom_chat_max_lines", "6", bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY), "Limits how many lines each message can have. Recommended to be low on servers.", 1, 10)
CreateConVar("custom_chat_enable_absence_messages", "1", bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY), "On first spawn, show messages about when a player was last present on the server.", 0, 1)
CreateConVar("custom_chat_enable_friend_messages", "1", bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY), "Show messages to players when their friends spawn on the server.", 0, 1)
CreateConVar("custom_chat_enable_dms", "1", bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY), "Allow players to chat with eachother privately.", 0, 1)
