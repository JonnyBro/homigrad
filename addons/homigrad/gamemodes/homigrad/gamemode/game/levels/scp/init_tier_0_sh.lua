...
scp.roles = {
	[1] = {
		"Учённый", Color(200, 200, 200), {"morphine", "medkit", "bandage"}
	},
	[2] = {
		"Охрана", Color(75, 75, 255), {"weapon_hk_usp", "weapon_mp5", "weapon_radio"}
	},
	[3] = {
		"МОГ", Color(0, 0, 125), {
			{"weapon_mk18", "weapon_m249"},
			"weapon_glock", "weapon_radio", "medkit", "adrenaline", "morphine"
		}
	}
}
