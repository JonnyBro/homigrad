resource.AddWorkshop("779759026") -- https://steamcommunity.com/sharedfiles/filedetails/?id=779759026
resource.AddWorkshop("367531149") -- https://steamcommunity.com/sharedfiles/filedetails/?id=367531149
resource.AddWorkshop("3080361312") -- https://steamcommunity.com/sharedfiles/filedetails/?id=3080361312 (reupload of old 830210642)
...
function scp.StartRoundSV()
	...
	return {
		spawnMOG = scp.spawnMOG
	}
end

function scp.RoundEndCheck()
	local TExit, TExit = 0, 0

	local TAlive = tdm.GetCountLive(team.GetPlayers(1), function(ply)
		if ply.exit then
			TExit = TExit + 1
...
function scp.PlayerInitialSpawn(ply)
	ply:SetTeam(1)
end
