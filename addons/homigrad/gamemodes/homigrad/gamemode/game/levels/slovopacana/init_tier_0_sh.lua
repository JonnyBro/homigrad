...
slovopacana.red = {
	"Октябрьские", Color(66, 135, 245), weapons = {"weapon_hands", "med_band_small"},
	main_weapon = {"weapon_molotok", "med_band_big", "med_band_small", "weapon_per4ik", "weapon_molotok", "med_band_big", "med_band_small", "weapon_per4ik", "shina"},
	...
	models = {"models/player/Group02/male_02.mdl", "models/player/Group02/male_04.mdl", "models/player/Group02/male_06.mdl", "models/player/Group02/male_08.mdl",}
}

slovopacana.blue = {
	"Шароваровы", Color(105, 196, 59), weapons = {"weapon_hands", "med_band_small"},
	main_weapon = {"weapon_molotok", "med_band_big", "med_band_small", "weapon_per4ik", "weapon_molotok", "med_band_big", "med_band_small", "weapon_per4ik", "shina"},
	secondary_weapon = {"weapon_hg_metalbat", "weapon_knife", "weapon_bat", "weapon_pipe", "weapon_hg_metalbat", "weapon_bat", "weapon_pipe", "weapon_hg_metalbat", "weapon_bat", "weapon_pipe"},
	models = {"models/player/Group02/male_02.mdl", "models/player/Group02/male_04.mdl", "models/player/Group02/male_06.mdl", "models/player/Group02/male_08.mdl",}
}
