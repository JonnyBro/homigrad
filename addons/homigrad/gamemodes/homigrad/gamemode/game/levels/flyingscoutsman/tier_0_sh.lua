...
scout.red = {
	"Голуби", Color(255, 75, 75), weapons = {"weapon_binokle", "weapon_radio", "weapon_gurkha", "weapon_hands", "med_band_big", "med_band_small", "medkit", "painkiller", "shina"},
	main_weapon = {"weapon_slb_scout"},
	models = models
}

scout.blue = {
	"Воробьи", Color(75, 75, 255), weapons = {"weapon_binokle", "weapon_radio", "weapon_hands", "weapon_kabar", "med_band_big", "med_band_small", "medkit", "painkiller", "weapon_handcuffs", "shina"},
	main_weapon = {"weapon_slb_scout"},
	models = models
}
