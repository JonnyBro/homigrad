...
bodycam.red = {
	"Террористы", Color(176, 0, 0), weapons = {"weapon_hands", "weapon_hg_hatchet", "med_band_big", "weapon_radio", "shina", "medkit"},
...
bodycam.blue = {
	"Контр-Терористы", Color(79, 59, 187), weapons = {"megamedkit", "weapon_hg_hatchet", "weapon_hands", "medkit", "painkiller", "weapon_handcuffs", "weapon_radio", "shina", "weapon_slb_awp", "weapon_slb_sg552", "weapon_slb_aug", "weapon_slb_scout"},
