...
bahmut.blue = {
	"НАТО", Color(125, 125, 60), weapons = {"megamedkit", "weapon_binokle", "weapon_hands", "weapon_kabar", "med_band_small", "med_band_big", "med_band_small", "painkiller", "weapon_hg_f1", "weapon_handcuffs", "weapon_radio", "shina"},
