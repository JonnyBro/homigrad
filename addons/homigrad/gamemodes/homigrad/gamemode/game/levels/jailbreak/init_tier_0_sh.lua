...
jailbreak.red = {
	"ФСИН", Color(55, 55, 255), weapons = {"weapon_radio", "weapon_police_bat", "weapon_hands", "weapon_taser", "weapon_handcuffs", "weapon_glock", "med_band_big", "shina"},
...
jailbreak.green = {
	"Заключенный", Color(255, 170, 0), weapons = {"weapon_hands"},
...
jailbreak.blue = {
	"ФСИН", Color(55, 55, 255), weapons = {"weapon_radio", "weapon_hands", "weapon_kabar", "med_band_big", "med_band_small", "medkit", "painkiller", "weapon_hg_f1", "weapon_handcuffs", "weapon_taser", "weapon_hg_flashbang", "shina"},
