...
riot.red = {
	"Полиция", Color(55, 55, 150), weapons = {"weapon_hands", "weapon_police_bat", "med_band_big", "med_band_small", "weapon_taser", "weapon_handcuffs", "weapon_radio", "shina"},
...
riot.blue = {
	"Бунтующие", Color(75, 45, 45), weapons = {"weapon_hands", "med_band_small"},
