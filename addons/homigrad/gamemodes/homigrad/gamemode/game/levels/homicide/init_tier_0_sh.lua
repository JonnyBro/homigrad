...
homicide.red = {
	"Невиновный", Color(125, 125, 125), models = tdm.models
}
...
function homicide.GetTeamName(ply)
	...
	if teamID == 1 then return "Невиновный", ScoreboardSpec end
	if teamID == 3 then return "Спецназ", blue end
end
...
function homicide.HUDPaint_RoundLeft(white2)
	...
	if time > 0 then
		...
		acurcetime = "До спавна лута: " .. acurcetime -- TODO: do we need this?
