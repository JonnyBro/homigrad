...
hook.Add("Fake Up", "PlayerClass", function(ply) return ply:PlayerClassEvent("ShouldFakeUp") end)
hook.Add("Fake", "PlayerClass", function(ply) return ply:PlayerClassEvent("ShouldFake") end)
hook.Add("PlayerCanPickupWeapon", "PlayerClass", function(ply, wep) return ply:PlayerClassEvent("ShouldUpWeapon", wep) end)
hook.Add("PlayerCanPickupItem", "PlayerClass", function(ply, item) return ply:PlayerClassEvent("ShouldUpItem", wep) end)
hook.Add("Shuold JMod Armor Equip", "PlayerClass", function(ply) return ply:PlayerClassEvent("JModArmorEquip") end)