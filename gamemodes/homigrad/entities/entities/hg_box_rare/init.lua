...
local secondAll = {"weapon_deagle", "food_tushenka", "food_spongebob_home", "painkiller", "med_band_big", "med_band_small", "medkit", "weapon_handcuffs", "weapon_pepperspray", "weapon_taser", "weapon_gurkha", "weapon_knife", "weapon_kabar", "weapon_hg_kitknife"}
